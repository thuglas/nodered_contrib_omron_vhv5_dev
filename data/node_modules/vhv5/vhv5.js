...
//        });
    ...
    RED.httpAdmin.get("/triggerVHV5", RED.auth.needsPermission('vhv5.trigger'), function(req,res) {
        console.log("Triggering VHV5");
        RED.httpNode.put("http://192.168.250.19/api/control/trigger", function(req, res) {
            // Process the incoming request body
            const requestBody = req.body;

            // Log the received data
            console.log("Received PUT request with body: " + JSON.stringify(requestBody));

        });
        console.log("Triggered VHV5");
